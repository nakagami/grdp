...
func (o *OrderPdu) processSecondaryOrder(r io.Reader) error {
	...
	slog.Info("Secondary:%v", SecondaryOrderType(orderType))
	...
	default:
		slog.Debug("Unsupport order type 0x%x", orderType)
	}
...
func (o *OrderPdu) processPrimaryOrder(r io.Reader) error {
	...
	case ORDER_TYPE_TEXT2:
		p = &GlayphIndex{}
	default:
		slog.Error(fmt.Sprintf("Not Support order type:%v", orderType))
